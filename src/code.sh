...
sambamba depth region -L bedfile -T 20 -m -F "mapping_quality >= 20 and not duplicate and not failed_quality_control" $bamfile_prefix.bam > $bamfile_prefix.sambamba_output.bed
